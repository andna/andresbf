    ...
    <div class="container-postit-svg">
        ...
        <svg width={svgSize} height={svgSize} viewBox="0 0 360 360" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {:else if currentPostType === 1}
                <mask id="mask0_{postId}" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="5" y="0" width="350" height="352">
                    <path d="M351.875 0H5.13902C5.13902 0 9.63916 306.764 5.13902 329.682C0.638887 352.6 106.139 352.764 212.639 349.764C290.838 347.561 354.139 329.264 354.139 329.264C354.139 329.264 340.639 295.764 351.875 0Z" fill="url(#paint0_linear_{postId})"/>
                </mask>
                <g mask="url(#mask0_{postId})">
                    <rect x="3.13916" y="-5.23621" width="382.131" height="376.23" fill="url(#paint1_linear_{postId})"/>
                </g>
                <defs>
                    <linearGradient id="paint0_linear_{postId}" x1="187.138" y1="-5.23622" x2="187.138" y2="358.682" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96E6B1"/>
                        <stop offset="1" stop-color="#63DD94"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear_{postId}" x1="194.139" y1="22.7638" x2="194.139" y2="363.764" gradientUnits="userSpaceOnUse">
            ...
            {:else if currentPostType === 2}
                <g clip-path="url(#clip0_{postId})">
                    <mask id="mask0_{postId}" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="358" height="360">
                        <path d="M358 0.215286L1.49998 0.21529C1.49998 0.21529 -4.67198 314.047 10.8466 340.157C26.3652 366.267 358 359.1 358 359.1L358 0.215286Z" fill="url(#paint0_linear_{postId})"/>
                    </mask>
                    <g mask="url(#mask0_{postId})">
                        <rect width="382.131" height="376.23" fill="url(#paint1_linear_{postId})"/>
                    </g>
                ...
                <defs>
                    <linearGradient id="paint0_linear_{postId}" x1="180.397" y1="0.215289" x2="180.397" y2="372.467" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96E6B1"/>
                        <stop offset="1" stop-color="#63DD94"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear_{postId}" x1="191.066" y1="4.39011e-06" x2="42" y2="311" gradientUnits="userSpaceOnUse">
                        <stop stop-color={currentDetailColors[0][0]}/>
            ...
            {:else}
                <g clip-path="url(#clip0_{postId})">
                    <mask id="mask0_{postId}" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-5" y="0" width="365" height="358">
                        <path d="M360 0L4.14704 3.00407e-05C4.14704 3.00407e-05 -10.7391 358 -1.86802 358C7.00302 358 89.4506 353 200.598 350C282.21 347.797 360 350 360 350L360 0Z" fill="url(#paint0_linear_{postId})"/>
                    </mask>
                    <g mask="url(#mask0_{postId})">
                        <rect x="-1.02148" y="-10.9999" width="382.131" height="376.23" fill="url(#paint1_linear_{postId})"/>
                    </g>
                </g>
                <defs>
                    <linearGradient id="paint0_linear_{postId}" x1="194.09" y1="-11" x2="194.09" y2="352.918" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#96E6B1"/>
                        <stop offset="1" stop-color="#63DD94"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear_{postId}" x1="215.479" y1="314.5" x2="217.979" y2="15.5001" gradientUnits="userSpaceOnUse">
                        <stop stop-color={currentDetailColors[0][0]}/>
